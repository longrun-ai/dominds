    ...
    const intro =
      language === 'zh'
        ...
        : [
            ...
            '- Tools: this dialog is expected to be tool-less; do not attempt any tool calls.',
            '- Ask-back: `!?@tellasker` is allowed only when you must clarify critical missing context; otherwise do not emit any tellasks.',
