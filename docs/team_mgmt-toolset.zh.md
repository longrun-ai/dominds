...
| `team_mgmt_prepare_occurrence_replace` | `txt` | 规划 `.minds/` 下多 occurrence 字面量批量替换       | `.minds/**`      |
| `team_mgmt_apply_occurrence_replace`   | `txt` | 应用 `.minds/` 下已规划的多 occurrence 字面量替换   | `.minds/**`      |
