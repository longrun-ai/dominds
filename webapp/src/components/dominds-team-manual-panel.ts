...
export class DomindsTeamManualPanel extends HTMLElement {
  ...
  private getStyles(): string {
    return `
      ...
      .topic{appearance:none;border:1px solid var(--color-border-primary,#e2e8f0);background:var(--dominds-bg,#fff);color:var(--color-fg-secondary,#475569);border-radius:999px;padding:6px 10px;font-size: var(--dominds-font-size-sm, 12px);cursor:pointer;}
